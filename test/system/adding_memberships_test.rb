...
class AddingMembershipsTest < ApplicationSystemTestCase
  test 'can calculate price with and without discount' do
    ...
    klass2 = FactoryBot.build(:klass, fixed_fee: 110, fixed_fee_with_discount: 100, non_regular_fee: 120, non_regular_fee_with_discount: 105, non_regular_alt_fee: 115, non_regular_alt_fee_with_discount: 110)
